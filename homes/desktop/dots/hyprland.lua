...
hl.env("GTK_THEME", "Catppuccin-Dark-Frappe")
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(FFFFFFff)", "rgba(FFFFFFcc)"}, angle = 45 },
...
hl.bind(mainMod .. " + SHIFT + oslash", hl.dsp.window.move({ direction = "right" }))
